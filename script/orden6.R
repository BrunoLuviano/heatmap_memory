...
diff_exp<-diff_exp[order(diff_exp$`a/b`),]
strains_2<-as.vector(diff_exp[,1])
...
b<-a
c<-select(c,-x)
diff_exp<-select(diff_exp,-x)
strains_3<-as.data.frame(strains_2)
rownames(strains_3)<-strains_2
strains_3<-as.data.frame(t(strains_3))
strains_3<-select(strains_3,-x)

strains_4<-as.data.frame(strains)
rownames(strains_4)<-strains
strains_4<-as.data.frame(t(strains_4))
strains_4<-select(strains_4,-x)

strains_5<-as.data.frame(strains_1)
rownames(strains_5)<-strains_1
strains_5<-as.data.frame(t(strains_5))
strains_5<-select(strains_5,-x)
